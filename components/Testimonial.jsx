...
//import swiper reaction components
...
//sample dta for projects with various categories
const slides = [
  {
  ...
  },
  {
    img: "/assets/testimonial/img-6.png",
    name: "Harrison Oluku",
    message: "Amazing attention to detail, my site looks professional",
  },
  {
    ...
    <div className="py-16 overflow-hidden">
      <div className=" container mx-auto">
        <AnimatedText
          ...
          textStyles="h1 text-5xl mb-[30px] xl:mb-[60px] text-center"
        />
        <div className="flex flex-col lg:flex-row gap-12">
          {/* slider info */}
          <div className="w-max xl:w-[600px] flex flex-col justify-center items-center xl:items-start text-center xl:text-left mx-auto xl:0">
