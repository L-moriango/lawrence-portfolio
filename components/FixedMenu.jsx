...
const FixedMenu = () => {
  ...
  return (
    <div className="fixed w-full h-[400px] z-50 flex justify-center pointer-events-none bg-transparent">
                ...
                <div>
                  <div className="flex gap-12 mb-12">
                    ...
                    <div className="flex flex-col">
                      <div className="text-[25px] text-accent mb-2">
                        <FiMapPin />
                      </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <p>lawrencemoriango27@gamil.com</p>
                    </div>
                  </div>
                  {/* socials */}
                  <Socials
                    containerStyles="flex gap-2"
                    iconStyles="text-[20px] w-[32] h-[32] text-primary flex items-center justify-center, rounded-full"
                  />
                </div>
              </div>
            </div>
      ...
      {isMobile ? (
        <div className="fixed z-50 bottom-2">
          <button
            onClick={() => setShowMenu(!showMenu)}
            className="bg-accent hover:bg-[#035A69] transition-colors duration-300 shadow-custom w-[54px] h-[54px] rounded-lg cursor-pointer flex items-center justify-center select-none pointer-events-auto"
          >
        ...
        <AnimatePresence>
          {showMenuButton && (
            <motion.div
              ...
              className="fixed z-50 bottom-16 pointer-events-auto mb-0"
            >
              <button
                onClick={() => setShowMenu(!showMenu)}
                className="bg-accent hover:bg-[#035A69] transition-colors duration-300 shadow-custom w-[54px] h-[54px] mb-6 rounded-lg cursor-pointer flex items-center justify-center select-none"
              >
                <CgMenuGridR className="text-4xl text-white" />
              </button>
            </motion.div>
