...
const Card = ({
  ...
  return (
    <div className="w-full h-[300px] overflow-hidden flex items-center justify-center sticky top-1">
      <div className="w-[1170px] h-[300px] border border-accent/80 bg-[#f4ffff] rounded-[8px] p-2 ">
          ...
          <div className="flex-1 flex items-center justify-center xl:justify-start md:py-8 md:px-16">
            <div className="flex flex-col xl:flex-row items-center xl:items-start gap-4 text-center xl:text-left xl:gap-10 px-4 xl:px-0">
              ...
              <div className="xl:border-l xl:border-secondary/10 xl:pl-12 w-full">
                ...
                <p className="text-base max-w-[780px] flex justify-items">
                  {description}
                </p>
                <p className="text-base max-w-[780px] xl:flex items-center  mt-1 mb-2 xl:mt-0">
                  {description2}
                </p>
              </div>
            </div>
